        ...
        case 'FLEET_MANAGER':
            return [
                ...
                },
                {
                    title: 'Vehicles',
                    icon: 'ri-bus-line',
                    route: '/fleet-manager/vehicles',
                },
                {
                    title: 'Drivers',
                    icon: 'ri-user-star-line',
                    route: '/fleet-manager/drivers',
                },
                {
                    title: 'Trips Management',
                    icon: 'ri-roadster-line',
                    route: '/fleet-manager/trips',
                },
                {
                    title: 'Maintenance',
                    icon: 'ri-tools-line',
                    route: '/fleet-manager/maintenance',
                },
                {
                    title: 'Fuel & Expenses',
                    icon: 'ri-gas-station-line',
                    route: '/fleet-manager/fuel-expenses',
                },
                {
                    title: 'Reports & Analytics',
                    icon: 'ri-bar-chart-2-line',
                    route: '/fleet-manager/reports',
                },
                {
                    title: 'Users Management',
                    icon: 'ri-team-line',
                    route: '/fleet-manager/users',
                },
                {
                    title: 'Settings',
                    icon: 'ri-settings-4-line',
                    route: '/fleet-manager/settings',
                },
            ];
        case 'DRIVER':
            return [
        ...
        case 'SAFETY_OFFICER':
            return [
                ...
                },
                {
                    ...
                    route: '/safety-officer/drivers',
                },
                {
                    title: 'Vehicles',
                    icon: 'ri-truck-line',
                    route: '/safety-officer/vehicles',
                },
                {
                    title: 'Maintenance',
                    icon: 'ri-tools-line',
                    route: '/safety-officer/maintenance',
                },
                {
                    title: 'Reports',
                    icon: 'ri-file-chart-line',
                    route: '/safety-officer/reports',
                },
            ];
                        ...
                        children: [
                            {
                                ...
                                route: '/fleet-manager/finance/dashboard',
                            },
                            {
                                title: 'Expenses',
                                icon: 'ri-coins-line',
                                route: '/fleet-manager/finance/expenses',
                            },
                            {
                                title: 'Fuel Logs',
                                icon: 'ri-gas-station-line',
                                route: '/fleet-manager/finance/fuel',
                            },
                            {
                                title: 'Reports & Analytics',
                                icon: 'ri-line-chart-line',
                                route: '/fleet-manager/finance/reports',
                            },
                        ],
                    },
                ];
            ...
            case 'FINANCIAL_ANALYST':
                return [
                    ...
                    },
                    {
                        title: 'Expenses',
                        icon: 'ri-coins-line',
                        route: '/financial-analyst/expenses',
                    },
                    {
                        title: 'Fuel Logs',
                        icon: 'ri-gas-station-line',
                        route: '/financial-analyst/fuel',
                    },
                    {
                        title: 'Reports & Analytics',
                        icon: 'ri-line-chart-line',
                        route: '/financial-analyst/reports',
                    },
                ];
            default:
                return [];
